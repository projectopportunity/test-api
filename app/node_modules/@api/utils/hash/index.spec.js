...
describe('the "hash" module', () => {
  ...
  describe('the exported object', () => {
    ...
    it('should have a property called "hashPattern"', () => {
      const instance = T
      expect(instance).to.have.property('hashPattern')
    })

    describe('the "hashPattern" property', () => {
      it('should be a regular expression', () => {
        expect(T.hashPattern).to.be.instanceOf(RegExp)
      })
    })
    ...
    describe('the "compareToHash" property', () => {
      ...
      context('when the plain text value is not the same as was used to create the hash originally', () => {
        const plainTextValue = 'test'
        let hash
        ...
        it('should return false', () => {
          ...
          const actual = T.compareToHash('not-what-we-want', hash)
          expect(actual).to.equal(expected)
        })
      })
    })
